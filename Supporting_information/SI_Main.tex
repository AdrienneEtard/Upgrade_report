...
\textbf{Mammals}                                      & 129          & 7           & 2           & 28                                      & 131                                           & \textit{\begin{tabular}[c]{@{}l@{}}Heterogeomys cherriei\\ Heterogeomys dariensis\\ Hylopetes sagitta\\ Marmosa paraguayana\\ Neoromicia malagasyensis\\ Plecturocebus discolor\\ Proechimys trinitatis\end{tabular}}   \\ \hline
\textbf{Birds}                                        & 158          & 7           & 0           & 22                                      & 156                                           & \textit{\begin{tabular}[c]{@{}l@{}}Aerodramus vanikorensis\\ Antrostomus arizonae\\ Calendulauda erythrochlamys\\ Eolophus roseicapilla\\ Myiothlypis rivularis\\ Poecile hudsonicus\\ Spermestes bicolor\end{tabular}} \\ \hline
\textbf{Reptiles}                                     & 68           & 2           & 0           & 17                                      & 68                                            & \textit{\begin{tabular}[c]{@{}l@{}}Liolaemus curicensis\\ Salvator merianae\end{tabular}}                                                                                                                               \\ \hline
\textbf{Amphibians}                                   & 41           & 4           & 2           & 8                                       & 43                                            & \textit{\begin{tabular}[c]{@{}l@{}}Lithobates berlandieri\\ Uperodon taprobanicus\end{tabular}}                                                                                                                         \\ \hline
\end{tabular}
\end{center}
\end{table}
...
%%%% Case study 2
\subparagraph{Case study 2: replicated tips are not sister clades, but the accepted name (tip label) figures in the original, uncorrected tree.}
...
\subparagraph{Case study 3: replicated tips are not sister clades, and the accepted name (tip label) does not figure in the original, uncorrected tree.} These were the problematic species listed in Table \ref{Phyrep}.
\begin{figure}[h!]
\centering
